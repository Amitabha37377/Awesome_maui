...
-- {{{ Wibar
--textclock widget
mytextclock = wibox.widget.textclock('<span color="#ffffff" font="Inter Bold Font 12"> %a %b %d, %H:%M </span>', 10)
...
awful.screen.connect_for_each_screen(function(s)
	...
	mydock = awful.wibar({ position = "left", screen = s, width = 50, opacity = 0.8, bg = "#000000" })
